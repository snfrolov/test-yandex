...
Функционал: Проверка Яндекс.почты
  ...
  Сценарий: Отправка письма с темой
    ...
    И значение элемента "Счетчик непрочитанных писем" сохранено в переменную "Количество непрочитанных писем до отправки"
    И выполнено нажатие на кнопку "Себе"
    ...
    И значение элемента "Счетчик непрочитанных писем" сохранено в переменную "Количество непрочитанных писем после отправки"
    И значение из переменной "Количество непрочитанных писем после отправки" больше на 1 значения из переменной "Количество непрочитанных писем до отправки"